...
namespace WinFormsApp3
{
    public class Modbus
    {
        ...
        public delegate void DelSetText(string txt);
        public DelSetText SetText;
        ...
        async void StartServerAsync()
        {
            ...
            if (SetText != null) SetText("서버 대기 중...");
            bIsConnected = false;
            ...
            while (true)
            {
                ...
                bIsConnected = true;
                if (SetText != null) SetText($"클라이언트 {connectedClients.Count}개 연결됨");
        ...
        async Task HandleClientAsync(TcpClient client)
        {
            ...
            if (SetText != null) SetText($"클라이언트 연결 해제됨. 현재: {connectedClients.Count}개");
